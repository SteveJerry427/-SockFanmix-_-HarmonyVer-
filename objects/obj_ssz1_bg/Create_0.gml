/// @description Add background
	...
	add_background(spr_ssz1_bg_layer_4, 0, 0.925, 0.925, 0, 0, 0, -96);
	add_background(spr_ssz1_bg_layer_6, 0, 0.90, 0.90, 0, 0, 0, -80);
	add_background(spr_ssz1_bg_layerc_1, 0, 0.80, 0.90, -0.10, 0, 0, -96);
	add_background(spr_ssz1_bg_layer_8, 0, 0.85, 0.90, 0, 0, 0, -64);
	add_background(spr_ssz1_bg_layer_10_2, 0, 0.80, 0.85, 0, 0, 0, -16);
	add_background(spr_ssz1_bg_layerc_2, 0, 0.70, 0.87, -0.20, 0, 0, -32);
	add_background(spr_ssz1_bg_layer_11, 0, 0.75, 0.85, 0, 0, 0, -16);
	add_background(spr_ssz1_bg_layerc_3, 0, 0.60, 0.87, -0.30, 0, 0, -16);
	add_background(spr_ssz1_bg_layer_12, 0, 0.65, 0.80, 0, 0, 0, 144);
	add_background(spr_ssz1_bg_layer_14, 0, 0.30, 0.85, -0.40, 0, 0, 272);
